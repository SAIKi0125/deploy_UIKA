...
private:
    ...
    CatchballPerception catchball_perception;
    int mujoco_base_body_id = -1;
    int mujoco_ball_body_id = -1;
    int mujoco_ball_joint_id = -1;
    int mujoco_ball_qpos_adr = -1;
    int mujoco_ball_dof_adr = -1;
    bool mujoco_ball_in_flight = false;
    double mujoco_next_throw_time = 0.8;
    double mujoco_throw_start_time = 0.0;
    std::mt19937 mujoco_throw_rng{0};
    void InitCatchballMujoco();
    void UpdateCatchballThrowMujoco();
    void UpdateCatchballObservationMujoco();
    void HideCatchballMujoco();
    void ThrowCatchballMujoco();
